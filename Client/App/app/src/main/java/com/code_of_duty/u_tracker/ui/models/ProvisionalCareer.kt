...
val careers:MutableList<Provisional> = mutableListOf(
    ...
    Provisional(id = "10", name = "Licenciatura en Filosofía", faculty = "2"),
    Provisional(id = "11", name = "Licenciatura en Teología", faculty = "2"),
    Provisional(id = "12", name = "Licenciatura en Inglés", faculty = "2"),
    Provisional(id = "13", name = "Licenciatura en Jurídica", faculty = "3")
)
